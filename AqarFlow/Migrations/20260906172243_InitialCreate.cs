        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropertySize = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "CustomerPropertyInterests",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerPropertyInterests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerPropertyInterests_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerPropertyInterests_Properties_PropertyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerPropertyInterests_CustomerId",
                table: "CustomerPropertyInterests",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerPropertyInterests_PropertyId",
                table: "CustomerPropertyInterests",
                column: "PropertyId");
